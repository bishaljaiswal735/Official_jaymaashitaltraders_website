...
function CutRectangle(props) {
  ...
  return (
    <div className="w-full relative flex flex-col items-center group">
      {/* SVG Container - now includes hover scaling */}
      <div className="w-full relative transition-all duration-300 transform group-hover:scale-105 group-hover:z-10">
        ...
        >
          ...
          {/* Background shape with visible stroke */}
          <path
            d="
              m 0 6
              a 6 6 0 0 1 6 -6
      ...
      {/* Details Container - now scales with hover and has fixed height */}
            ...
            <div className="flex flex-col gap-2 text-sm flex-grow relative">
              <div>
                ...
                <div className="absolute bottom-0 left-0 right-0 w-full ">
                  ...
                  <button className="bg-blue-400 w-full p-1 cursor-pointer">Get Latest Price</button></a>
